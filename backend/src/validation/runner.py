...
from ..models.canonical import CanonicalEvent, QualityFlag, Stage
...
def load_quality_rules(path: str | Path) -> dict[str, Any]:
...
class ValidationRunner:
    ...
    @classmethod
    def from_config(cls, path: str | Path) -> "ValidationRunner":
        return cls(rules=load_quality_rules(path))
